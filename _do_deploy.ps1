...
cp "$WEBAPP/list.json" "$DEST/list.json"
mkdir -p "$DEST/data"
cp "$WEBAPP/data/agenda.json" "$WEBAPP/data/salaries.json" "$WEBAPP/data/legends.json" "$WEBAPP/data/official-leagues.json" "$WEBAPP/data/expanded-leagues.json" "$DEST/data/"
