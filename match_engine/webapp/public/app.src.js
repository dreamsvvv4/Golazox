...
const I18N = {
  es: {
    ...
    'pen-takers-loading':'Cargando tiradores…','pen-takers-hint':'↕ Arrastra · ⇄ Cambiar','pen-bench-label':'Suplentes',
    ...
    'trn-rule-modality':'Fase de Grupos',
    'trn-rule-modality-off':'Jugar solo eliminatorias directas (KO).',
    'trn-rule-modality-on':'Jugar liguilla previa a las eliminatorias.',
    'trn-rule-idavuelta':'Ida y vuelta','trn-rule-match-fmt':'Partidos de Ida y Vuelta',
    'trn-rule-match-fmt-off':'Todas las rondas a partido único.',
    'trn-rule-match-fmt-on':'Eliminatorias a doble partido (excepto la final).',
    'trn-rule-tiebreak':'Prórroga',
    'trn-rule-tiebreak-off':'En caso de empate, ir directamente a la tanda de penaltis.',
    'trn-rule-tiebreak-on':'Jugar tiempo extra antes de los penaltis.',
    'trn-rule-third':'Tercer y Cuarto Puesto',
    'trn-rule-third-off':'Los semifinalistas eliminados se van a casa.',
    'trn-rule-third-on':'Jugar un partido extra por la medalla de bronce.',
    'trn-rule-legs':'Doble Vuelta',
    'trn-rule-legs-off':'Solo ida — una vuelta completa.',
    'trn-rule-legs-on':'Doble vuelta — todos se enfrentan dos veces.',
    'trn-rule-group-stage':'Fase de grupos',
    'trn-rule-group-hint-off':'Partido único por jornada.',
    'trn-rule-group-hint-on':'Ida y vuelta en la liguilla.',
    'trn-rule-group-hint':'Partido único por jornada.',
    'trn-rule-group-hint2':'Partido único en grupos.',
    'trn-rule-ko-stage':'Partidos de Ida y Vuelta',
    'trn-rule-ko-hint-off':'Eliminatorias a partido único.',
    'trn-rule-ko-hint-on':'Doble partido en cada ronda KO (la final, siempre única).',
    'trn-rule-ko-hint':'Ida y vuelta en rondas KO · la final siempre a partido único',
  ...
  en: {
    ...
    'pen-takers-loading':'Loading kickers…','pen-takers-hint':'↕ Drag · ⇄ Swap','pen-bench-label':'Bench',
    ...
    'trn-rule-modality':'Group Stage',
    'trn-rule-modality-off':'Play direct knockout rounds only.',
    'trn-rule-modality-on':'Play a group stage before the knockouts.',
    'trn-rule-idavuelta':'Two legs','trn-rule-match-fmt':'Two-Legged Ties',
    'trn-rule-match-fmt-off':'All rounds played as single matches.',
    'trn-rule-match-fmt-on':'Knockout rounds played over two legs (except the final).',
    'trn-rule-tiebreak':'Extra Time',
    'trn-rule-tiebreak-off':'Draws go straight to a penalty shootout.',
    'trn-rule-tiebreak-on':'Play extra time before penalties.',
    'trn-rule-third':'Third-Place Play-off',
    'trn-rule-third-off':'Eliminated semi-finalists go home.',
    'trn-rule-third-on':'Play an extra match for the bronze medal.',
    'trn-rule-legs':'Double Round-Robin',
    'trn-rule-legs-off':'Single round-robin — one match each.',
    'trn-rule-legs-on':'Double round-robin — home and away for everyone.',
    'trn-rule-group-stage':'Group stage',
    'trn-rule-group-hint-off':'Single match per matchday.',
    'trn-rule-group-hint-on':'Two legs in the group stage.',
    'trn-rule-group-hint':'Single match per matchday.',
    'trn-rule-group-hint2':'Single match in groups.',
    'trn-rule-ko-stage':'Two-Legged Ties',
    'trn-rule-ko-hint-off':'Knockout rounds as single matches.',
    'trn-rule-ko-hint-on':'Two legs per knockout round (final always single).',
    'trn-rule-ko-hint':'Two legs in KO rounds · final always single match',
...
const STADIUMS = [
  { id:'bernabeu',   name:'Santiago Bernabéu',    city:'Madrid',          country:'España',
    ...
    img: _imgProxy('Santiago_Bernabeu_Stadium.webp') },
  ...
  { id:'wembley',    name:'Wembley Stadium',       city:'Londres',         country:'Inglaterra',
    ...
    img: _imgProxy('Wembley_stadium.webp') },
  ...
  { id:'dortmund',   name:'BVB-Stadion Dortmund',  city:'Dortmund',        country:'Alemania',
    ...
    img: _imgProxy('Signal_Iduna_Park.webp') },
  { id:'oldtrafford',name:'Old Trafford',          city:'Mánchester',      country:'Inglaterra',
    ...
    img: _imgProxy('Old_Trafford.webp') },
  ...
  { id:'azteca',     name:'Estadio Azteca',        city:'Ciudad de México', country:'México',
    ...
    img: _imgProxy('Estadio_azteca.webp') },
  ...
  { id:'celtic',     name:'Celtic Park',           city:'Glasgow',         country:'Escocia',
    ...
    img: _imgProxy('Celtic_Park.webp') },
];
