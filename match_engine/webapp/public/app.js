...
const PLAYER_OVERRIDES = new Map([
  ...
  ['peter cech',     88], ['cech',            88],
  ['van der sar',    89],
  ['oliver kahn',    92], ['kahn',            92],
  ['lev yashin',     95], ['yashin',          95],
  ['dino zoff',      91], ['zoff',            91],
  ['walter zenga',   85], ['reina',           84],
  ['donnarumma',     90], ['keylor navas',    86],
  ...
  ['xavi hernández', 93], ['xavi hernandez', 93], ['xavi',     93],
  ...
  ['luis suárez',    91], ['suarez',         91], ['suárez',   91],
  ['neymar',         93],
  ...
  ['thierry henry',  93], ['henry',          93],
  ['jürgen klinsmann',87],['klinsmann',      87],
  ['thomas müller',  88], ['müller',         88], ['muller',   88],
  ...
  ['david villa',    89], ['lamine yamal',   87],
  ['angel di maria', 88], ['wesley sneijder',88], ['sneijder', 88],
