...
public class AutoCompleteTextField extends JTextField {
    ...
    public AutoCompleteTextField(String text, int columns, List<String> history) {
        ...
        setupAutoComplete();
        // Ensure readable default colors and caret/selection visibility
    ...
    /**
     * Disable autocomplete behavior for scenarios where the field should behave like a plain JTextField.
     * Removes key/focus listeners related to history collection and suggestion popup and clears history.
     */
    public void disableAutoComplete() {
        ...
        // Clear history and hide popup if visible
